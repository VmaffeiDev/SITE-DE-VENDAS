  ...
  return (
    ...
    >
      <div className="lg:grid lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)] lg:items-stretch">
        ...
        <div key={activeVehicle.id} className="spotlight-in flex flex-col justify-between gap-6 border-t border-line bg-white p-5 text-ink sm:p-7 lg:border-l lg:border-t-0">
